...
- (void)layoutSubviews {
    ...
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:self.mjLabADLogo.bounds byRoundingCorners:UIRectCornerTopLeft cornerRadii:CGSizeMake(5, 5)];
...
//    KMJADType mjAdType = bannerAds.mjAdType;
    ...
    [self.mjLabADLogo setText:[@(indexPath.row) stringValue]];
    //
    [self fill:impAds];
}
