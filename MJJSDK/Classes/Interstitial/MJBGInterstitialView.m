...
/** <#注释#>*/
@property (nonatomic,assign)id currentInterstitial;
...
//    [[MJGLInterstitial sharedInstance] removeFromSuperview];
    ...
    switch (self.mjInterstitialStyle) {
        ...
        case KMJInterstitialIMGStyle: {
            //
            currentInterstitial = [MJIMGInterstitial sharedInstance];
            break;
        }
        case KMJInterstitialGLStyle: {
            //
            currentInterstitial = [MJGLInterstitial sharedInstance];
            break;
        }
        case KMJInterstitialMDStyle: {
        
            currentInterstitial = [MJMDInterstitial sharedInstance];
            break;
    ...
    self.currentInterstitial = currentInterstitial;
    [self.mjInterstitialView addSubview:currentInterstitial];
}
...
- (void)masonryStyle{
    ...
    [self.currentInterstitial mas_makeConstraints:^(MASConstraintMaker *make) {
        //
        make.edges.equalTo(superView);
    }];
...
- (UIView *)mjInterstitialView
{
    if(!_mjInterstitialView){
        ...
        [_mjInterstitialView.layer setMasksToBounds:YES];
    }
