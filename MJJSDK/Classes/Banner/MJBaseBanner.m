...
- (void)showNext{
    ...
    [animation1 setFromValue:@(from)];
    [animation1 setToValue:@(to)];
...
//    animation1.autoreverses = YES;
    ...
    [animation2 setFromValue:@(from)];
    [animation2 setToValue:@(to)];
...
//    group.removedOnCompletion = NO;
    [self.layer addAnimation:group forKey:@"ShowNext"];
//    [self.layer addAnimation:animation1 forKey:@"ShowNext1"];
//    [self.layer addAnimation:animation2 forKey:@"ShowNext2"];
